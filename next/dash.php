<?php 
    if (isset($_GET["address"]) && !empty($_GET["address"])) {
        ...
        ob_start();
        include("http://data.bter.com/api/1/ticker/VTC_BTC");
        ...
        ob_start();
        include("https://api.mintpal.com/v1/market/stats/VTC/BTC");
        $MintPal = ob_get_contents();
        ob_end_clean();

        ob_start();
        include("http://pubapi.cryptsy.com/api.php?method=singlemarketdata&marketid=151");
        $Cryptsy = ob_get_contents();
        ob_end_clean();

        ob_start();
        include("https://api.vircurex.com/api/get_last_trade.json?base=VTC&alt=BTC");
        ...
        ob_start();
        include("https://explorer.vertcoin.org/chain/VERTCOIN/q/addressbalance/" . $address);
        $amount = (float) ob_get_contents();
        ob_end_clean();
        ...
        $cP1 = $json_e["return"]["markets"]["VTC"]["recenttrades"]["0"]["price"]; // This and the following lines pull the 10 most recent buy/sell orders on Cryptsy
        $cP2 = $json_e["return"]["markets"]["VTC"]["recenttrades"]["1"]["price"];
        $cP3 = $json_e["return"]["markets"]["VTC"]["recenttrades"]["2"]["price"];
        $cP4 = $json_e["return"]["markets"]["VTC"]["recenttrades"]["3"]["price"];
        $cP5 = $json_e["return"]["markets"]["VTC"]["recenttrades"]["4"]["price"];
        $cP6 = $json_e["return"]["markets"]["VTC"]["recenttrades"]["5"]["price"];
        $cP7 = $json_e["return"]["markets"]["VTC"]["recenttrades"]["6"]["price"];
        $cP8 = $json_e["return"]["markets"]["VTC"]["recenttrades"]["7"]["price"];
        $cP9 = $json_e["return"]["markets"]["VTC"]["recenttrades"]["8"]["price"];
        $cP10 = $json_e["return"]["markets"]["VTC"]["recenttrades"]["9"]["price"];
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="intro-text">
                        ...
                        <span class="name">ᗐ<?php echo $formAmount ?></span>
                        <hr class="star-light">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12"><div class="row">
                    ...
                    VTC Price: $<?php echo $formDogePriceVirc ?></font>
                    </div>
                    </div>
                </div>
            </div>
