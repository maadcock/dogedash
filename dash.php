<?php 
    if (isset($_GET["address"]) && !empty($_GET["address"])) {
        ...
        ob_start();
        include("http://data.bter.com/api/1/ticker/DOGE_BTC");
        ...
        ob_start();
        include("https://api.mintpal.com/v1/market/stats/DOGE/BTC");
        $MintPal = ob_get_contents();
        ob_end_clean();

        ob_start();
        include("http://pubapi.cryptsy.com/api.php?method=singlemarketdata&marketid=132");
        $Cryptsy = ob_get_contents();
        ob_end_clean();

        ob_start();
        include("https://api.vircurex.com/api/get_last_trade.json?base=DOGE&alt=BTC");
        ...
        ob_start();
        include("http://dogechain.info/chain/Dogecoin/q/addressbalance/" . $address);
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="intro-text">
                        ...
                        <span class="name">&#0208;<?php echo $formAmount ?></span>
                        <hr class="star-light">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12"><div class="row">
                    ...
                    <font size="2">Satoshi: <?php echo $formSatoshiBter ?><br />
                    BTC Price: $<?php echo $formBTCPrice ?><br />
                    DOGE Price: $<?php echo $formDogePriceBter ?></font>
                    </div>
                    <div class="col-sm-3 text-center">
                    <strong><font size="3">Cryptsy Value</font></strong><br />
                    <font size="7"><strong>$<?php echo $formFinalCryptsy ?></strong></font><br />
                    <font size="2">Satoshi: <?php echo $formSatoshiCryptsy ?><br />
                    BTC Price: $<?php echo $formBTCPrice ?><br />
                    DOGE Price: $<?php echo $formDogePriceCryptsy ?></font>
                    </div>
                    <div class="col-sm-3 text-center">
                    <strong><font size="3">MintPal Value</font></strong><br />
                    <font size="7"><strong>$<?php echo $formFinalMint ?></strong></font><br />
                    <font size="2">Satoshi: <?php echo $formSatoshiMint ?><br />
                    BTC Price: $<?php echo $formBTCPrice ?><br />
                    DOGE Price: $<?php echo $formDogePriceMint ?></font>
                    </div>
                    <div class="col-sm-3 text-center">
                    <strong><font size="3">Vircurex Value</font></strong><br />
                    <font size="7"><strong>$<?php echo $formFinalVirc ?></strong></font><br />
                    <font size="2">Satoshi: <?php echo $formSatoshiVirc ?><br />
                    BTC Price: $<?php echo $formBTCPrice ?><br />
                    DOGE Price: $<?php echo $formDogePriceVirc ?></font>
                    </div>
                    </div>
                </div>
            </div>
