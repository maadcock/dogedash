<?php 
    if (isset($_GET["address"]) && !empty($_GET["address"])) {
        ...
        ob_start();
        include("http://chainz.cryptoid.info/drk/api.dws?q=getbalance&a=" . $address);
        ...
        $formAmount = number_format((float) $amount, 4, ".", ",");
